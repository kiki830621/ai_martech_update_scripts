#!/usr/bin/env Rscript
#####
# DERIVATION: D01_05 App Views (AMZ)
# VERSION: 2.0
# PLATFORM: amz
# GROUP: D01
# SEQUENCE: 05
...
# CONSUMES: cleansed_data.df_dna_by_customer___cleansed, cleansed_data.df_profile_by_customer___cleansed
# PRODUCES: app_data.df_dna_by_customer, app_data.df_profile_by_customer, app_data.df_segments_by_customer
# DEPENDS_ON_DRV: amz_D01_04
# PRINCIPLE: MP064, MP145, DEV_R037, DEV_R038, DM_R022, DM_R044
#####
#amz_D01_05

#' @title D01_05 App Views (AMZ)
