#!/usr/bin/env Rscript
#####
# DERIVATION: D01_02 RFM Calculation (CBZ)
# VERSION: 2.0
# PLATFORM: cbz
# GROUP: D01
# SEQUENCE: 02
...
#' @title D01_02 RFM Calculation (CBZ)
#' @description Calculate RFM metrics from customer aggregation tables
#' @input_tables processed_data.df_cbz_sales_by_customer
#' @output_tables processed_data.df_cbz_customer_rfm
